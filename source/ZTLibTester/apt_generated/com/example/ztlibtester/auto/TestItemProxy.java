...
public class TestItemProxy implements IBeanProxy {
	...
	public static final String TABLE = "tbl_Test";
	public static final String TABLE_CREATOR = "create table tbl_Test(_id integer primary key autoincrement, column_1 INTEGER, column_2 REAL, column_3 INTEGER, column_4 TEXT);";
